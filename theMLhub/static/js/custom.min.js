...
jQuery(window).on("load", function() {
    ...
    if ($('#preloader').length) {
        sleep(1300)  // Sleep for 1.3 seconds
            .then(() => {
                ...
                // Toggle the hamburger menu based on sidebar style
                $('body').attr('data-sidebar-style') === "mini" ? $(".hamburger").addClass('is-active') : $(".hamburger").removeClass('is-active');
            });
    } else {
        // If #preloader doesn't exist, immediately do the rest
        $('#main-wrapper').addClass('show');
        $('body').attr('data-sidebar-style') === "mini" ? $(".hamburger").addClass('is-active') : $(".hamburger").removeClass('is-active');
    }
});
...
// jQuery(window).on("load", function() {
//     sleep(1300)  // Sleep for 2 seconds
//         .then(() => {
//     $('#preloader').fadeOut(1);
//
//     $('#main-wrapper').addClass('show');
